...
//Below this if for mobile: "touchstart"
  rock_div.addEventListener('touchstart', function() {
    updateResults('Rock');
    game('Rock');
  })

  paper_div.addEventListener('touchstart', function() {
    updateResults('Paper');
    game('Paper');
  })

  scissors_div.addEventListener('touchstart', function() {
    updateResults('Scissors');
    game('Scissors');
  })
  resetTimer(1)
